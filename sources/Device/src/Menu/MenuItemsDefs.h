...
static const ButtonBase name = { Item_Button, 0, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},   \
    funcPress, funcDraw };

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define DEF_TIME(name, titleRU, titleEN, hintRU, hintEN, keeper, funcActive, cur, h, mi, s, mo, d, y)                           \
static const TimeBase name = { Item_Time, 0, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},       \
    &cur, &h, &mi, &s, &mo, &d, &y };

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define DEF_GOVERNOR(name, titleRU, titleEN, hintRU, hintEN, cell, min, max, keeper, funcActive, funcChanged, funcBeforeDraw)   \
static const GovernorBase name = {Item_Governor, 0, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},\
...
static const GovernorColorBase name = {Item_GovernorColor, 0, false, Page::Name::NoPage, &keeper, FuncActive,                          \
...
static const ChoiceBase name = {Item_Choice, 2, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                        \
...
static const ChoiceBase name = {Item_Choice, 3, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,         \
...
static const ChoiceBase name = {Item_Choice, 4, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,         \
    hints##name, funcChanged, funcDraw};
...
static pString hints##name[] = {nameRu1, nameEn1, nameRu2, nameEn2, nameRu3, nameEn3, nameRu4, nameEn4,                                             \
    nameRu5, nameEn5};                                                                                                                              \
static const ChoiceBase name = {Item_Choice, 5, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,         \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {Item_Choice, 6, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,         \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {Item_Choice, 7, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,         \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {Item_Choice, 8, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,         \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {Item_ChoiceReg, 9, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,      \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {Item_ChoiceReg, 10, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,     \
    hints##name, funcChanged, funcDraw};
