...
static const ButtonBase name = { Control::Type::Button, 0, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},         \
    funcPress, funcDraw };

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define DEF_TIME(name, titleRU, titleEN, hintRU, hintEN, keeper, funcActive, cur, h, mi, s, mo, d, y)                                           \
static const TimeBase name = { Control::Type::Time, 0, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},             \
    &cur, &h, &mi, &s, &mo, &d, &y };

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define DEF_GOVERNOR(name, titleRU, titleEN, hintRU, hintEN, cell, min, max, keeper, funcActive, funcChanged, funcBeforeDraw)                   \
static const GovernorBase name = {Control::Type::Governor, 0, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},      \
...
static const GovernorColorBase name = {Control::Type::GovernorColor, 0, Page::Name::NoPage, &keeper, FuncActive,                                \
...
static const PageBase name = {Control::Type::Page, 1, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                         \
...
static const PageBase name = {Control::Type::Page, 2, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                         \
    items##name, funcPress, FuncDrawPage, FuncRegSetPage};
...
static const PageBase name = {Control::Type::Page, 3, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                         \
    items##name, funcPress, FuncDrawPage, FuncRegSetPage};
...
static const PageBase name = {Control::Type::Page, 4, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                         \
    items##name, funcPress, FuncDrawPage, FuncRegSetPage};
...
static const PageBase name = {Control::Type::Page, 5, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                         \
    items##name, funcPress, FuncDrawPage, FuncRegSetPage};
...
static const Control * const  items##name[] = {(Control *)item1, (Control *)item2, (Control *)item3, (Control *)item4, (Control *)item5,        \
    (Control *)item6};                                                                                                                          \
static const PageBase name = {Control::Type::Page, 6, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                         \
    items##name, funcPress, FuncDrawPage, FuncRegSetPage};
...
static const PageBase name = {Control::Type::Page, 7, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                         \
    items##name, funcPress, FuncDrawPage, FuncRegSetPage};
...
static const PageBase name = {Control::Type::Page, 8, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                         \
    items##name, funcPress, FuncDrawPage, FuncRegSetPage};
...
static const PageBase name = {Control::Type::Page, 9, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                  \
    items##name, funcPress, FuncDrawPage, FuncRegSetPage};
...
static const PageBase name = {Control::Type::Page, 10, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                        \
    items##name, funcPress, FuncDrawPage, FuncRegSetPage};
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define DEF_GPAPH_BUTTON(name, titleRU, titleEN, hintRU, hintEN, keeper, funcActive, funcPress, funcDraw)                                           \
...
static const ChoiceBase name = {Control::Type::Choice, 2, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},              \
...
static const ChoiceBase name = {Control::Type::Choice, 3, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,\
...
static const ChoiceBase name = {Control::Type::Choice, 4, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,       \
    hints##name, funcChanged, funcDraw};
...
static pString hints##name[] = {nameRu1, nameEn1, nameRu2, nameEn2, nameRu3, nameEn3, nameRu4, nameEn4,                                                     \
    nameRu5, nameEn5};                                                                                                                                      \
static const ChoiceBase name = {Control::Type::Choice, 5, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,       \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {Control::Type::Choice, 6, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,       \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {Control::Type::Choice, 7, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,       \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {Control::Type::Choice, 8, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,       \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {Control::Type::ChoiceReg, 9, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,    \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {Control::Type::ChoiceReg, 10, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,   \
    hints##name, funcChanged, funcDraw};
